...
@Profile({ "testWithDB" })
@Configuration
@EnableJpaRepositories("com.zvenova.smart_url.domain.repository")
...
public class DatabaseTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factoryBean.setPackagesToScan("com.zvenova.smart_url");
        factoryBean.setPersistenceUnitName("smart_url");
